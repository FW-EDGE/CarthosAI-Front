    ...
    >
      <div
        style={{
          ...
          zIndex: 0,
          background:
            "radial-gradient(ellipse 70% 50% at 15% 5%, rgba(0,195,237,0.12) 0%, transparent 55%), radial-gradient(ellipse 55% 45% at 85% 95%, rgba(0,100,123,0.09) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center justify-start flex-1 px-6 pt-16 pb-10">
        ...
        <div style={{ marginBottom: "3rem", textAlign: "center" }}>
          ...
          >
            ...
            <span style={{ color: "var(--primary-fixed)" }}>
                    ...
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow: isSelected
                          ? "var(--shadow-float), 0 0 0 2px var(--primary)"
                          : "var(--shadow-card)",
            ...
            >
                ...
                >
                  ...
                  <span
                    style={{
                      width: 1,
                      height: 12,
                      background: "rgba(0,100,123,0.25)",
                    }}
                  />
                  <span
                    style={{
              ...
              >
                ...
                <button
                  ...
                  style={{
                    minWidth: 200,
                    opacity: topic.trim() && !isGenerating ? 1 : 0.45,
                    pointerEvents:
                      topic.trim() && !isGenerating ? "auto" : "none",
                    display: "flex",
                    alignItems: "center",
                    gap: "0.5rem",
                  }}
